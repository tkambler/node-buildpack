...
export LD_LIBRARY_PATH=$HOME/oracle/instantclient:${LD_LIBRARY_PATH:-}
export OCI_LIB_DIR=$HOME/oracle/instantclient
export OCI_INC_DIR=$HOME/oracle/instantclient/sdk/include
